...
class UIStrings:
    ...
    READY_MSG = "Ready."
    TASK_ALREADY_RUNNING_MSG = "Transfer already in progress."
    TARGET_FOLDER_NOT_SET_MSG = "Please select a target folder."
    STARTING_TRANSFER_MSG = "Starting transfer..."
    STARTING_FILE_DELETION_MSG = "Starting file deletion..."
    START_USB_TRANSFER_MSG = "Starting USB Mass Storage transfer..."
    FILES_FOUND_MSG = "Found {} files."
    TRANSFERRING_FILES_MSG = "Transferring files..."
    DELETING_FILES_MSG = "Deleting files..."
    FILES_MOVED_MSG = "Files moved to: {}"
    FILES_DELETED_MSG = "Files deleted from: {}"
    FILES_NOT_FOUND_MSG = "No files found."
    TRANSFER_ERROR_MSG = "Transfer failed: {}"
    DELETE_ERROR_MSG = "File deletion failed: {}"
